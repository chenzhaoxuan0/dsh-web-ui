	...
	factory: (require) => {
		...
		const SKIN_CENTER_ENTRIES = [
			...
			},
			{
				"id": "twilight-mirror",
				"name": "暮色镜湖",
				"nameEn": "Twilight Mirror",
				"author": "dsh-web-ui（参考 preset-twilight-mirror 主题）",
				"tagline": "蓝紫暮光与静水倒影 · 薰衣草紫调色板 · 半透明面板",
				"description": "《暮色镜湖》— 在蓝紫暮光与静水倒影之间保持专注：暮色镜湖背景画（蓝紫暮光天幕、静水倒影、远景群山）垫在半透明面板之下，遮罩随亮/暗主题实时切换，深海军蓝表面搭配薰衣草粉紫强调色（accent #d89be8）与雾蓝点缀（#79b9f4）重映射到全部 dsh token，暗色变体为深海夜航调。",
				"tags": [
					"twilight",
					"mirror",
					"lavender",
				...
				"accent": "#d89be8",
				"bodyAttr": "data-dsh-twilight-mirror",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\chenziyu\project\Agent\dsh\dsh-web-ui\packages\skins\skin-center\src\client\skin-center.module.css.mjs
		const css = "body[data-dsh-skin-center] .YIRaOW_pluginCard{border:1px solid var(--dsw-alias-border-l1,#e2e8f0);background:var(--dsw-alias-bg-layer-2,#fff);border-radius:8px;list-style:none;overflow:hidden}body[data-dsh-skin-center] .YIRaOW_cardHeader{width:100%;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;padding:11px 14px;transition:background .12s;display:flex}body[data-dsh-skin-center] .YIRaOW_cardHeader:hover{background:var(--dsw-alias-bg-layer-1,#f1f5f9)}body[data-dsh-skin-center] .YIRaOW_cardHeader:active{background:var(--dsw-alias-bg-layer-3,#e6ecf4)}body[data-dsh-skin-center] .YIRaOW_cardHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .YIRaOW_headText{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}body[data-dsh-skin-center] .YIRaOW_pluginName{color:var(--dsw-alias-label-primary,#172a45);align-items:baseline;gap:8px;font-size:13.5px;font-weight:600;display:flex}body[data-dsh-skin-center] .YIRaOW_cardDescription{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12px;line-height:1.4}body[data-dsh-skin-center] .YIRaOW_chevron,body[data-dsh-skin-center] .YIRaOW_chevronOpen{color:var(--dsw-alias-label-secondary,#6b7280);flex:none;margin-left:10px;font-size:12px;transition:transform .12s}body[data-dsh-skin-center] .YIRaOW_chevronOpen{transform:rotate(180deg)}body[data-dsh-skin-center] .YIRaOW_cardBody{border-top:1px solid var(--dsw-alias-border-l1,#e2e8f0);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}body[data-dsh-skin-center] .YIRaOW_head{flex-direction:column;gap:6px;display:flex}body[data-dsh-skin-center] .YIRaOW_titleBadge{color:var(--dsw-alias-label-secondary,#6b7280);font-size:11px;font-weight:500}body[data-dsh-skin-center] .YIRaOW_intro{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12.5px;line-height:1.55}body[data-dsh-skin-center] .YIRaOW_themeRow{align-items:center;gap:8px;margin-top:2px;display:flex}body[data-dsh-skin-center] .YIRaOW_themeLabel{color:var(--dsw-alias-label-secondary,#6b7280);margin-right:2px;font-size:12px}body[data-dsh-skin-center] .YIRaOW_themeButton{border:1px solid var(--dsw-alias-border-l3,#cbd5e1);background:var(--dsw-alias-bg-layer-2,#fff);color:var(--dsw-alias-label-primary,#172a45);cursor:pointer;border-radius:6px;padding:5px 10px;font-size:12px;line-height:1;transition:background .12s,border-color .12s,color .12s}body[data-dsh-skin-center] .YIRaOW_themeButton:hover{border-color:var(--dsw-alias-border-l4,#94a3b8)}body[data-dsh-skin-center] .YIRaOW_themeButton:active{border-color:var(--dsw-alias-brand-primary,#2b7cd9);background:var(--dsw-alias-button-primary-dimmed,#e8f1fc);color:var(--dsw-alias-brand-primary,#1e63b8)}body[data-dsh-skin-center] .YIRaOW_themeButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .YIRaOW_themeButtonActive{border-color:var(--dsw-alias-brand-primary,#2b7cd9);background:var(--dsw-alias-button-primary-dimmed,#e8f1fc);color:var(--dsw-alias-brand-primary,#1e63b8)}body[data-dsh-skin-center] .YIRaOW_list{flex-direction:column;gap:10px;display:flex}body[data-dsh-skin-center] .YIRaOW_card{border:1px solid var(--dsw-alias-border-l1,#e2e8f0);background:var(--dsw-alias-bg-layer-2,#fff);border-radius:10px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}body[data-dsh-skin-center] .YIRaOW_cardHead{align-items:center;gap:10px;min-width:0;display:flex}body[data-dsh-skin-center] .YIRaOW_swatch{width:14px;height:14px;box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l4,#0f172a1f);border-radius:50%;flex:none}body[data-dsh-skin-center] .YIRaOW_cardName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13.5px;font-weight:600;overflow:hidden}body[data-dsh-skin-center] .YIRaOW_cardTagline{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12px;line-height:1.45}body[data-dsh-skin-center] .YIRaOW_badge{letter-spacing:.02em;border-radius:999px;flex:none;min-width:0;margin-left:auto;padding:2px 8px;font-size:11px;font-weight:600}body[data-dsh-skin-center] .YIRaOW_badgeActive{color:var(--dsw-alias-state-success-primary,#0f6b3a);background:var(--dsw-alias-state-success-tertiary,#dcf3e5)}body[data-dsh-skin-center] .YIRaOW_badgeTrying{color:var(--dsw-alias-brand-primary,#1e63b8);background:var(--dsw-alias-button-primary-dimmed,#e2edfc)}body[data-dsh-skin-center] .YIRaOW_actions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}body[data-dsh-skin-center] .YIRaOW_button{border:1px solid var(--dsw-alias-border-l3,#cbd5e1);background:var(--dsw-alias-bg-layer-2,#fff);color:var(--dsw-alias-label-primary,#172a45);cursor:pointer;border-radius:7px;padding:6px 12px;font-size:12px;line-height:1;transition:background .12s,border-color .12s,color .12s}body[data-dsh-skin-center] .YIRaOW_button:hover:not(:disabled){border-color:var(--dsw-alias-brand-primary,#2b7cd9);color:var(--dsw-alias-brand-primary,#1e63b8)}body[data-dsh-skin-center] .YIRaOW_button:active:not(:disabled){border-color:var(--dsw-alias-button-primary-hover,#1e63b8);background:var(--dsw-alias-button-primary-dimmed,#e8f1fc);color:var(--dsw-alias-brand-primary,#1e63b8)}body[data-dsh-skin-center] .YIRaOW_button:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .YIRaOW_buttonPrimary{border-color:var(--dsw-alias-brand-primary,#2b7cd9);background:var(--dsw-alias-button-primary-fill,#2b7cd9);color:var(--dsw-alias-label-primary-foreground,#fff)}body[data-dsh-skin-center] .YIRaOW_buttonPrimary:hover:not(:disabled){border-color:var(--dsw-alias-button-primary-hover,#1e63b8);background:var(--dsw-alias-button-primary-hover,#1e63b8);color:var(--dsw-alias-label-primary-foreground,#fff)}body[data-dsh-skin-center] .YIRaOW_buttonPrimary:active:not(:disabled),body[data-dsh-skin-center] .YIRaOW_buttonPrimary:focus-visible:not(:disabled){border-color:var(--dsw-alias-button-primary-hover,#1e63b8);background:var(--dsw-alias-button-primary-hover,#1e63b8)}body[data-dsh-skin-center] .YIRaOW_buttonGhost{background:0 0;border-color:#0000}body[data-dsh-skin-center] .YIRaOW_button:disabled{opacity:.55;cursor:default}body[data-dsh-skin-center] .YIRaOW_error{color:var(--dsw-alias-state-error-primary,#b42318);font-size:12px}body[data-dsh-skin-center] .YIRaOW_backgroundRow{flex-direction:column;gap:6px;padding:8px 0;display:flex}body[data-dsh-skin-center] .YIRaOW_backgroundHead{align-items:center;gap:8px;display:flex}body[data-dsh-skin-center] .YIRaOW_backgroundLabel{color:var(--dsw-alias-label-primary,#172a45);font-size:12.5px;font-weight:600}body[data-dsh-skin-center] .YIRaOW_backgroundValue{font-variant-numeric:tabular-nums;color:var(--dsw-alias-brand-primary,#2b7cd9);flex:none;margin-left:auto;font-size:12px}body[data-dsh-skin-center] .YIRaOW_backgroundRange{background:var(--dsw-alias-bg-layer-3,#e2e8f0);-webkit-appearance:none;appearance:none;cursor:pointer;border-radius:999px;width:100%;height:4px;margin:0}body[data-dsh-skin-center] .YIRaOW_backgroundRange::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;border:2px solid var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-brand-primary,#2b7cd9);width:14px;height:14px;box-shadow:0 0 0 1px var(--dsw-alias-border-l4,#0f172a1f);cursor:pointer;border-radius:50%}body[data-dsh-skin-center] .YIRaOW_backgroundRange::-moz-range-thumb{border:2px solid var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-brand-primary,#2b7cd9);width:12px;height:12px;box-shadow:0 0 0 1px var(--dsw-alias-border-l4,#0f172a1f);cursor:pointer;border-radius:50%}body[data-dsh-skin-center] .YIRaOW_backgroundRange:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .YIRaOW_backgroundHint{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12px;line-height:1.5}body[data-dsh-skin-center] .YIRaOW_backgroundHintMuted{color:var(--dsw-alias-label-tertiary,#9aa4b5);font-size:12px;line-height:1.5}@media (prefers-reduced-motion:reduce){body[data-dsh-skin-center] .YIRaOW_cardHeader,body[data-dsh-skin-center] .YIRaOW_themeButton,body[data-dsh-skin-center] .YIRaOW_button,body[data-dsh-skin-center] .YIRaOW_chevron,body[data-dsh-skin-center] .YIRaOW_chevronOpen{transition:none}}";
		...
		var skin_center_module_css_default = {
			"actions": "YIRaOW_actions",
			"backgroundHead": "YIRaOW_backgroundHead",
			"backgroundHint": "YIRaOW_backgroundHint",
			"backgroundHintMuted": "YIRaOW_backgroundHintMuted",
			"backgroundLabel": "YIRaOW_backgroundLabel",
			"backgroundRange": "YIRaOW_backgroundRange",
			"backgroundRow": "YIRaOW_backgroundRow",
			"backgroundValue": "YIRaOW_backgroundValue",
			"badge": "YIRaOW_badge",
			"badgeActive": "YIRaOW_badgeActive",
			"badgeTrying": "YIRaOW_badgeTrying",
			"button": "YIRaOW_button",
			"buttonGhost": "YIRaOW_buttonGhost",
			"buttonPrimary": "YIRaOW_buttonPrimary",
			"card": "YIRaOW_card",
			"cardBody": "YIRaOW_cardBody",
			"cardDescription": "YIRaOW_cardDescription",
			"cardHead": "YIRaOW_cardHead",
			"cardHeader": "YIRaOW_cardHeader",
			"cardName": "YIRaOW_cardName",
			"cardTagline": "YIRaOW_cardTagline",
			"chevron": "YIRaOW_chevron",
			"chevronOpen": "YIRaOW_chevronOpen",
			"error": "YIRaOW_error",
			"head": "YIRaOW_head",
			"headText": "YIRaOW_headText",
			"intro": "YIRaOW_intro",
			"list": "YIRaOW_list",
			"pluginCard": "YIRaOW_pluginCard",
			"pluginName": "YIRaOW_pluginName",
			"swatch": "YIRaOW_swatch",
			"themeButton": "YIRaOW_themeButton",
			"themeButtonActive": "YIRaOW_themeButtonActive",
			"themeLabel": "YIRaOW_themeLabel",
			"themeRow": "YIRaOW_themeRow",
			"titleBadge": "YIRaOW_titleBadge"
		};
		//#endregion
